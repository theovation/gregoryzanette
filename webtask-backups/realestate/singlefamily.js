...
module.exports = function(context, cb) {
  ...
  rp('http://idx.mlspin.com/idx.asp?user=2KzB9t1MntTFtnBNR7rtdjYyLe2YAztAtuN2tKPrnZhAoFNP7cvUZDaPIDOLfPRqo2Pxtym&proptype=SF').then(function (response) {
    try {
...
/*
    for(var i = 0; i < quincyListings.length; i++) {
     db.collection("listings").update({ LIST_NO: quincyListings[i].LIST_NO },quincyListings[i],{ upsert: true },function(err, res){
     })      
    }  
...
saveToStorage("real-estate-data/singlefamily/allston/all.json", JSON.stringify({'listings': allstonListings }));
saveToStorage("real-estate-data/singlefamily/backbay/all.json", JSON.stringify({'listings': backbayListings }));
saveToStorage("real-estate-data/singlefamily/beaconhill/all.json", JSON.stringify({'listings': beaconhillListings }));
saveToStorage("real-estate-data/singlefamily/brighton/all.json", JSON.stringify({'listings': brightonListings }));
saveToStorage("real-estate-data/singlefamily/charlestown/all.json", JSON.stringify({'listings': charlestownListings }));
saveToStorage("real-estate-data/singlefamily/chinatown/all.json", JSON.stringify({'listings': chinatownListings }));
saveToStorage("real-estate-data/singlefamily/downtown/all.json", JSON.stringify({'listings': downtownListings }));
saveToStorage("real-estate-data/singlefamily/dorchester/all.json", JSON.stringify({'listings': dorchesterListings }));
saveToStorage("real-estate-data/singlefamily/eastboston/all.json", JSON.stringify({'listings': eastbostonListings }));
saveToStorage("real-estate-data/singlefamily/fenway/all.json", JSON.stringify({'listings': fenwayListings }));
saveToStorage("real-estate-data/singlefamily/financialdistrict/all.json", JSON.stringify({'listings': financialdistrictListings }));
saveToStorage("real-estate-data/singlefamily/hydepark/all.json", JSON.stringify({'listings': hydeparkListings }));
saveToStorage("real-estate-data/singlefamily/kenmore/all.json", JSON.stringify({'listings': kenmoreListings }));
saveToStorage("real-estate-data/singlefamily/missionhill/all.json", JSON.stringify({'listings': missionhillListings }));
saveToStorage("real-estate-data/singlefamily/northend/all.json", JSON.stringify({'listings': northendListings }));
saveToStorage("real-estate-data/singlefamily/roslindale/all.json", JSON.stringify({'listings': roslindaleListings }));
saveToStorage("real-estate-data/singlefamily/roxbury/all.json", JSON.stringify({'listings': roxburyListings }));
saveToStorage("real-estate-data/singlefamily/seaport/all.json", JSON.stringify({'listings': seaportListings }));
saveToStorage("real-estate-data/singlefamily/southboston/all.json", JSON.stringify({'listings': southbostonListings }));
saveToStorage("real-estate-data/singlefamily/southend/all.json", JSON.stringify({'listings': southendListings }));
saveToStorage("real-estate-data/singlefamily/westend/all.json", JSON.stringify({'listings': westendListings }));
saveToStorage("real-estate-data/singlefamily/westroxbury/all.json", JSON.stringify({'listings': westroxburyListings }));
saveToStorage("real-estate-data/singlefamily/brookline/all.json", JSON.stringify({'listings': brooklineListings }));
saveToStorage("real-estate-data/singlefamily/cambridge/all.json", JSON.stringify({'listings': cambridgeListings }));
saveToStorage("real-estate-data/singlefamily/dedham/all.json", JSON.stringify({'listings': dedhamListings }));
saveToStorage("real-estate-data/singlefamily/winthrop/all.json", JSON.stringify({'listings': winthropListings }));
saveToStorage("real-estate-data/singlefamily/marblehead/all.json", JSON.stringify({'listings': marbleheadListings }));
saveToStorage("real-estate-data/singlefamily/lexington/all.json", JSON.stringify({'listings': lexingtonListings }));
saveToStorage("real-estate-data/singlefamily/natick/all.json", JSON.stringify({'listings': natickListings }));
saveToStorage("real-estate-data/singlefamily/needham/all.json", JSON.stringify({'listings': needhamListings }));
saveToStorage("real-estate-data/singlefamily/newton/all.json", JSON.stringify({'listings': newtonListings }));
saveToStorage("real-estate-data/singlefamily/somerville/all.json", JSON.stringify({'listings': somervilleListings }));
saveToStorage("real-estate-data/singlefamily/waltham/all.json", JSON.stringify({'listings': walthamListings }));
saveToStorage("real-estate-data/singlefamily/watertown/all.json", JSON.stringify({'listings': watertownListings }));
saveToStorage("real-estate-data/singlefamily/wellesley/all.json", JSON.stringify({'listings': wellesleyListings }));
saveToStorage("real-estate-data/singlefamily/weston/all.json", JSON.stringify({'listings': westonListings }));
saveToStorage("real-estate-data/singlefamily/revere/all.json", JSON.stringify({'listings': revereListings }));
saveToStorage("real-estate-data/singlefamily/quincy/all.json", JSON.stringify({'listings': quincyListings }));
