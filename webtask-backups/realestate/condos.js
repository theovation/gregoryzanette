...
module.exports = function(context, cb) {
  ...
  rp('http://idx.mlspin.com/idx.asp?user=2KzB9t1MntTFtnBNR7rtdjYyLe2YAztAtuN2tKPrnZhAoFNP7cvUZDaPIDOLfPRqo2Pxtym&proptype=CC').then(function (response) {
    try {
...
console.log(backbayListings);
      
saveToStorage("real-estate-data/condos/allston/all.json", JSON.stringify({'listings': allstonListings }));
saveToStorage("real-estate-data/condos/backbay/all.json", JSON.stringify({'listings': backbayListings }));
saveToStorage("real-estate-data/condos/beaconhill/all.json", JSON.stringify({'listings': beaconhillListings }));
saveToStorage("real-estate-data/condos/brighton/all.json", JSON.stringify({'listings': brightonListings }));
saveToStorage("real-estate-data/condos/charlestown/all.json", JSON.stringify({'listings': charlestownListings }));
saveToStorage("real-estate-data/condos/chinatown/all.json", JSON.stringify({'listings': chinatownListings }));
saveToStorage("real-estate-data/condos/downtown/all.json", JSON.stringify({'listings': downtownListings }));
saveToStorage("real-estate-data/condos/dorchester/all.json", JSON.stringify({'listings': dorchesterListings }));
saveToStorage("real-estate-data/condos/eastboston/all.json", JSON.stringify({'listings': eastbostonListings }));

saveToStorage("real-estate-data/condos/fenway/all.json", JSON.stringify({'listings': fenwayListings }));
saveToStorage("real-estate-data/condos/financialdistrict/all.json", JSON.stringify({'listings': financialdistrictListings }));
saveToStorage("real-estate-data/condos/hydepark/all.json", JSON.stringify({'listings': hydeparkListings }));
saveToStorage("real-estate-data/condos/kenmore/all.json", JSON.stringify({'listings': kenmoreListings }));
saveToStorage("real-estate-data/condos/missionhill/all.json", JSON.stringify({'listings': missionhillListings }));
saveToStorage("real-estate-data/condos/northend/all.json", JSON.stringify({'listings': northendListings }));
saveToStorage("real-estate-data/condos/roslindale/all.json", JSON.stringify({'listings': roslindaleListings }));
saveToStorage("real-estate-data/condos/roxbury/all.json", JSON.stringify({'listings': roxburyListings }));
saveToStorage("real-estate-data/condos/seaport/all.json", JSON.stringify({'listings': seaportListings }));

saveToStorage("real-estate-data/condos/southboston/all.json", JSON.stringify({'listings': southbostonListings }));
saveToStorage("real-estate-data/condos/southend/all.json", JSON.stringify({'listings': southendListings }));
saveToStorage("real-estate-data/condos/westend/all.json", JSON.stringify({'listings': westendListings }));



saveToStorage("real-estate-data/condos/westroxbury/all.json", JSON.stringify({'listings': westroxburyListings }));
saveToStorage("real-estate-data/condos/brookline/all.json", JSON.stringify({'listings': brooklineListings }));

saveToStorage("real-estate-data/condos/cambridge/all.json", JSON.stringify({'listings': cambridgeListings }));
saveToStorage("real-estate-data/condos/dedham/all.json", JSON.stringify({'listings': dedhamListings }));

saveToStorage("real-estate-data/condos/winthrop/all.json", JSON.stringify({'listings': winthropListings }));
saveToStorage("real-estate-data/condos/marblehead/all.json", JSON.stringify({'listings': marbleheadListings }));



saveToStorage("real-estate-data/condos/lexington/all.json", JSON.stringify({'listings': lexingtonListings }));
saveToStorage("real-estate-data/condos/natick/all.json", JSON.stringify({'listings': natickListings }));
saveToStorage("real-estate-data/condos/needham/all.json", JSON.stringify({'listings': needhamListings }));
saveToStorage("real-estate-data/condos/newton/all.json", JSON.stringify({'listings': newtonListings }));
saveToStorage("real-estate-data/condos/somerville/all.json", JSON.stringify({'listings': somervilleListings }));
saveToStorage("real-estate-data/condos/waltham/all.json", JSON.stringify({'listings': walthamListings }));
saveToStorage("real-estate-data/condos/watertown/all.json", JSON.stringify({'listings': watertownListings }));
saveToStorage("real-estate-data/condos/wellesley/all.json", JSON.stringify({'listings': wellesleyListings }));
saveToStorage("real-estate-data/condos/weston/all.json", JSON.stringify({'listings': westonListings }));
saveToStorage("real-estate-data/condos/revere/all.json", JSON.stringify({'listings': revereListings }));
saveToStorage("real-estate-data/condos/quincy/all.json", JSON.stringify({'listings': quincyListings }));
